...
export default function VibeRadioCard() {
  ...
  return (
    <div className="flex h-full min-h-[134px] w-full flex-col justify-center overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900 shadow-sm transition-colors hover:border-zinc-700">
      <iframe
